...
public class KeyBindings {
    ...
    public static final KeyBinding aspectMenu = new KeyBinding(
            "key.aspectMenu",
            Keyboard.KEY_I,
            "key.cat.tcnodetracker");
    public static final KeyBinding toggleNodeLayer = new KeyBinding(
            "tcnodetracker.key.togglenode",
            Keyboard.KEY_NONE,
            "key.cat.tcnodetracker");
